...
namespace trieste
{
  namespace json
  {
    ...
    JSON_EXPORT Reader reader(bool allow_multiple = false);
    ...
    JSON_EXPORT std::string to_string(
      Node json,
      bool prettyprint = false,
      bool sort_keys = false,
      const std::string& indent = "  ");
    ...
    JSON_EXPORT bool equal(Node lhs_json, Node rhs_json);
    ...
    JSON_EXPORT std::string unescape(const std::string_view& string);
    ...
    JSON_EXPORT std::string escape_unicode(const std::string_view& string);
    ...
    JSON_EXPORT std::string escape(const std::string_view& string);
    ...
    JSON_EXPORT Node object(const std::initializer_list<Node>& members);
    ...
    /// `Number`
    JSON_EXPORT std::optional<double> get_number(const Node& value);
    ...
    /// `Boolean`
    JSON_EXPORT std::optional<bool> get_boolean(const Node& value);
    ...
    /// `String`
    JSON_EXPORT std::optional<Location> get_string(const Node& value);
    ...
    JSON_EXPORT Node select(const Node& document, const Location& pointer);
    ...
    /// @return the numeric value, or an empty optional if the node is not a
    /// `Number`
    JSON_EXPORT std::optional<double>
    ...
    /// @return the string value, or an empty optional if the node is not a
    /// `String`
    JSON_EXPORT std::optional<Location>
    ...
    /// not be applied
    JSON_EXPORT Node patch(const Node& document, const Node& patch);
  }
}
